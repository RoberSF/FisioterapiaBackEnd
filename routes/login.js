...
function obtenerMenu(ROLE) {
    ...
    var menu = [{
        ...
        },
        {
            ...
            submenu: [
                { title: 'Clínicas', url: '/hospitales' },
                { title: 'Profesionales', url: '/medicos' },
            ]
        }
    ]

    if (ROLE === 'ADMIN_ROLE') {
        menu[1].submenu.unshift({ title: 'Usuarios', url: '/usuarios' }, { title: 'Blog-edit', url: '/blog-edit' }, { title: 'Búsqueda en la web', url: '/buscar/:' })
    }
